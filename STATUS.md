...
- **Pendiente (opcional):** los extractos ICBC muy pesados ("TRANSF.MINORISTAS"/"MOVIMIENTOS") pueden tardar > 220s y caer en `error` → evaluar Haiku (`IMPORT_PARSER_MODEL_CHEAP`) o trocear el PDF para esos casos.
