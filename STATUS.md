...
### Sesión 2026-06-11 (bis) — Bulk de contraparte en la review (branch `feat/bulk-counterparty`, stackeado sobre `feat/imports-backlog`)
...
- [ ] **Pendiente:** merge (tras #50) + smoke manual en prod: bulk sobre líneas sin
  contraparte de un resumen TC.
